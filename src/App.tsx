...
const keyDateItemStyle: React.CSSProperties = {
  display: "flex",
  justifyContent: "space-between",
  alignItems: "center",
  marginBottom: "12px",
...
const isValidYMD = (s: unknown): s is string =>
...
const App: React.FC = () => {
  ...
  const xForDayPercent = (day: number) => {
    ...
    return ((day - 1) / (totalDaysForChart - 1)) * 100; // 0~100
  };
  ...
  // 讓「原本算但沒用」的日期字串真的派上用場（避免 TS6133）
  const keyDatesText = useMemo(() => {
    ...
    return { edemaRiseDateStr, stressRiseDateStr, pmsPeakDateStr };
  }, [lastStartDate, ovulationStartDay, lutealStartDay, pmsStartDay]);
  ...
  return (
    <div style={appContainerStyle}>
      ...
      <div style={dashboardCardStyle}>
        ...
        <div style={cardStyle(COLORS.border)}>
          <h3 style={cardTitleStyle(COLORS.accent)}>💖 今天的照顧方式</h3>
          <ul style={listStyle}>
      ...
      <div style={mentalSupportCardStyle(currentPhase.color)}>
        ...
        <div style={{ marginTop: 20, padding: "0 5px" }}>
          ...
          <div style={{ marginTop: 16, padding: "16px 18px", borderRadius: 18, border: `1px solid ${COLORS.border}`, background: "#fff" }}>
            ...
            <div style={{ width: "100%", height: 70, position: "relative", borderRadius: 14, backgroundColor: "#F8F9FC", border: `1px dashed ${COLORS.border}`, overflow: "hidden" }}>
            ...
            <div style={{ marginTop: 12, display: "grid", gap: 8 }}>
              {recentAnxietySeries.map((p) => (
                <div key={p.date} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", fontSize: "0.9rem", color: COLORS.textDark }}>
                  <span style={{ width: 54, fontFamily: "Nunito, sans-serif", color: COLORS.textGrey, fontWeight: 700 }}>
                    {formatShortDate(p.date)}
                  </span>
                  <div style={{ flex: 1, height: 8, borderRadius: 999, backgroundColor: COLORS.primaryLight, margin: "0 10px", overflow: "hidden" }}>
                    <div style={{ width: `${(p.anxiety / 10) * 100}%`, height: "100%", borderRadius: 999, backgroundColor: COLORS.primary }} />
                  </div>
      ...
      <div style={chartCardStyle}>
        ...
        <div style={{ position: "relative", height: "150px", marginTop: "10px" }}>
          <svg viewBox="0 0 340 150" style={{ width: "100%", height: "100%", overflow: "visible" }} preserveAspectRatio="none">
            ...
            <line x1={xForDay(pmsStartDay, 340)} y1="0" x2={xForDay(pmsStartDay, 340)} y2="150" stroke={COLORS.accent} strokeWidth="1.5" strokeDasharray="3,3" opacity="0.8" />
          </svg>
        ...
        <div style={keyDatesCardStyle}>
          ...
          <div style={{ marginBottom: 12, fontSize: "0.88rem", color: COLORS.textGrey, lineHeight: 1.5 }}>
            （提示）水腫開始上升：約 {keyDatesText.edemaRiseDateStr}｜壓力開始上升：約 {keyDatesText.stressRiseDateStr}｜PMS 起點：約 {keyDatesText.pmsPeakDateStr}
          </div>
          ...
          <div style={keyDateItemStyle}>
            ...
            <span style={keyDateValueStyle()}>
              {formatShortDate(addDays(lastStartDate, ovulationStartDay - 1))} ～ {formatShortDate(addDays(lastStartDate, ovulationEndDay - 1))} (Day {ovulationStartDay}–{ovulationEndDay})
            </span>
          </div>
      ...
      <div style={gridContainerStyle}>
        ...
        <div style={predictionCardStyle(COLORS.accent)}>
          ...
          <div style={modalContentStyle}>
            ...
            <div style={modalRecordSectionStyle}>
              ...
              <RecordDropdown
                ...
                onChange={(v) => setCurrentRecord({ ...currentRecord, appetite: v as Appetite })}
              ...
              <RecordDropdown
                ...
                onChange={(v) => setCurrentRecord({ ...currentRecord, mood: v as Mood })}
                accentColor={modalDetail.phase.accent}
              />
              <RecordDropdown
                label="水腫"
                ...
                onChange={(v) => setCurrentRecord({ ...currentRecord, body: v as Body })}
                accentColor={modalDetail.phase.accent}
              />
              <RecordDropdown
                label="睡眠"
                ...
                onChange={(v) => setCurrentRecord({ ...currentRecord, sleep: v as Sleep })}
                accentColor={modalDetail.phase.accent}
              />
